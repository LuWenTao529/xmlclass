...
def zero_shot_training(args, file_name, cur_type):
    file1 = open(f'{args.path}/{args.task}/{args.label_space_file}', 'r')
    ...
    path = f'{args.path}/{args.task}/{args.result_dir}'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--label_space_file", type=str, default="deepseek_chat/init_label_space.txt")
    parser.add_argument("--result_dir", type=str, default="deepseek_chat/result")
