...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", type=str, default="qwen3/init_label_space.txt")
    parser.add_argument("--keyphrase_dir", type=str, default="keyphrase_candidate/qwen3_label_50.txt")
    ...
    parser.add_argument("--output_dir", type=str, default="qwen3/tail_label.txt")
